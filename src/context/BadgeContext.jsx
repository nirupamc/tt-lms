  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="relative max-w-md w-full mx-4">
        {/* Animated background */}
        <div
          className={`absolute inset-0 bg-gradient-to-br ${tierColors[badge.tier]} opacity-20 rounded-xl blur-xl animate-pulse`}
        />
        ...
        <div className="relative bg-white dark:bg-slate-900 rounded-xl p-8 text-center shadow-2xl border">
          ...
          {/* Badge icon */}
          <div className="text-8xl mb-4 animate-bounce">{badge.icon_emoji}</div>
          ...
          <div className="space-y-2">
            ...
            <div
              className={`inline-block px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r ${tierColors[badge.tier]} text-white`}
            >
