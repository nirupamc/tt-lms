  ...
  return (
    ...
    >
      <Card className={`border-0 shadow-md transition-all duration-200 hover:shadow-lg ${
        targetMet ? 'bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20' : ''
      }`}>
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
                ...
                {streak.current_streak > 0 && (
                  <div className="flex items-center gap-2 text-sm">
                    <motion.span
                      ...
                      animate={streak.current_streak >= 3 ? { scale: [1, 1.2, 1] } : {}}
                      transition={{ 
                        repeat: Infinity, 
                        duration: 1,
                        repeatDelay: 1
            ...
            <div className="relative">
              ...
              >
                ...
                <motion.circle
                  ...
                  style={{
                    filter: targetMet ? 'drop-shadow(0 0 6px rgba(245, 158, 11, 0.5))' : 'none'
                  }}
                />
              </svg>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className={`text-xs font-semibold ${
                  targetMet ? 'text-amber-600 dark:text-amber-400' : 'text-indigo-600 dark:text-indigo-400'
                }`}>
          ...
          <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700">
            <div className="flex items-center justify-between text-sm">
              <span className="text-muted-foreground">
                {targetMet ? '🎉 Target achieved!' : `${(targetHours - weeklyHours).toFixed(1)}h remaining`}
              </span>
