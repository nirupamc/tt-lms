...
export const SidebarAccordion = memo(({ children, isExpanded, className = "" }) => {
  return (
    <motion.div
      className={className}
          ...
          <motion.div
            variants={{
              ...
              animate: { 
                ...
                height: "auto",
                transition: {
                  height: { duration: ANIMATION_CONFIG.durations.standard, ease: "easeOut" },
                  opacity: { duration: ANIMATION_CONFIG.durations.fast, delay: 0.1 }
                }
              },
              exit: { 
                opacity: 0, 
                ...
                transition: {
                  ...
                  height: { duration: ANIMATION_CONFIG.durations.standard, delay: 0.1, ease: "easeOut" }
                }
              }
            }}
...
export const CodeSuccessFlash = memo(({ children, isSuccess, onSuccessComplete }) => {
  return (
    <motion.div
...
export const AnimatedBar = memo(({ animationBegin = 0, animationDuration = 600, ...props }) => {
  return (
    <motion.div
      initial={{ scaleY: 0 }}
      animate={{ scaleY: 1 }}
...
export const FloatingLabelInput = memo(({ label, id, className = "", ...props }) => (
